...
<div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <?php if ($cek_foto['foto_bukti_bayar'] != '0') : ?>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <img src="<?= base_url('uploads/bukti/') . $cek_foto['foto_bukti_bayar']; ?>" width="270 px" style="border:2px ridge #0404B4;">
                        </div>
                    </div>
                    <form action="<?= base_url('superadmin/update_status_bayar') ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            <div class="col-sm-2 mb-3 mb-sm-0">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary btn-sm">Update Status
                                Pembayaran</button>
                        </div>
                    </form>
    ...
    <div class="modal-footer ml-auto">
        <a href="<?= base_url('superadmin/datapesanan'); ?>">
