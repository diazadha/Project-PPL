<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #d7552a;">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('superadmin') ?>">
                <div class="sidebar-brand-icon ">
                    <i class="fas fa-cow"></i>
                    <img src="<?= base_url('assets/img/') ?>qurban.in_sp.png" alt="" style="width: 100%; height:100%;">
                </div>
                <!-- <div class="sidebar-brand-text mx-3"> Qurban.In </div> -->
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('superadmin/logout'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $superadmin['nama_depan']; ?> <?= $superadmin['nama_belakang']; ?></span>
