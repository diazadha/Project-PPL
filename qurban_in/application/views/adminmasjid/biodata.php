     ...
     <div class="row">
         ...
         <div class="card shadow mb-6 col-xl-7 col-lg-4">
             <div class="card-header py-6">
                 <h6 class="m-0 font-weight-bold" style="color: #D7552A;">Biodata Tempat Distribusi</h6>
             </div>

             <div class="card-body">
                 <form action="<?= base_url('tempatdistribusi/update/') ?>" method="POST">
                     <input type="hidden" name="id_tempatdistribusi" placeholder="Nama Tempat" class="form-control" value="<?= $profil['id_tempatdistribusi'] ?>" required>
         ...
         <div class="col-xl-5 col-lg-7 col-sm-6">
             <div class="card shadow mb-4">
                 ...
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold " style="color: #d7552a;">Logo Tempat Distribusi</h6>
                 </div>
                 ...
                 <div class="card-body">
                     <form action="<?= base_url('tempatdistribusi/update_foto_tempat/'); ?>" method="post" enctype="multipart/form-data">
                         ...
                         <div class="col 1 mt-2 mb-4" align="center">
                             <?php if ($profil['foto_tempat']) : ?>
                                 <img src=" <?= base_url('uploads/tempatdistribusi/') . $profil['foto_tempat']; ?>" class="card-img" alt="..." style="width: 250px; height: 250px;">
                             <?php else : ?>
