                            ...
                            <center>
                                <div class="header-slider normal-slider">
                                    <div class="header-slider-item">
                                        <img src="<?= base_url('assets/'); ?>img/sapi_limosin.jpg" alt="Slider Image" style="height: 400px; width: 300px;" />
                                    </div>
                                    <div class="header-slider-item">
                                        <img src="<?= base_url('assets/'); ?>img/kambing.jpeg" alt="Slider Image" style="height: 400px; width: 300px;" />
                                    </div>
                                    <div class="header-slider-item">
                                        <img src="<?= base_url('assets/'); ?>img/kambing3.jpg" alt="Slider Image" style="height: 400px; width: 300px;" />
                                    </div>
                                </div>
